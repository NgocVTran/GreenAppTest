import json
from constants import COUNTRIES, TYPES_OF_HOUSING, HEATING_ENERGY_SOURCES, FUEL_TYPES, PREFERED_DIET, LOCAL_PRODUCT, BUY_FROM_COMPANES
...
class Equations:
    ...
    def __init__(self):
        self.max_car = 4
        self.coeffs = {}
        with open('metadataa', 'r', encoding='utf-8') as file:
